...
The alpha installers currently default to `v0.1.0-alpha.13` because prereleases are not always exposed through GitHub's `latest` release URL. To override the version later, set `GHSTPRTCL_VERSION`.
